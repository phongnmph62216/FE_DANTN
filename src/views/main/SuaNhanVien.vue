    ...
    <div class="grid grid-cols-12 gap-8">
      ...
      <div class="col-span-12 lg:col-span-9 space-y-5">
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          <div>
            <label class="block mb-2 font-medium"> Mã Nhân Viên * </label>
          ...
          <div>
            <label class="block mb-2 font-medium"> Ngày Vào Làm * </label>
...
const loadNhanVien = async () => {
  try {
    ...
    form.id = nv.id;
    form.anhDaiDien = nv.anhDaiDien;
    form.maNhanVien = nv.maNhanVien;
    form.hoVaTen = nv.hoVaTen;
    form.ngaySinh = nv.ngaySinh;
    form.matKhau = nv.matKhau;
    form.cccd = nv.cccd;
    form.gioiTinh = nv.gioiTinh;
    form.soDienThoai = nv.soDienThoai;
    form.email = nv.email;
    form.vaiTro = nv.vaiTro;
    form.ngayVaoLam = nv.ngayVaoLam;
    form.trangThai = nv.trangThai;

    previewImage.value = nv.anhDaiDien
      ? `http://localhost:8080/uploads/${nv.anhDaiDien}`
      : null;

    // xử lý địa chỉ
    if (nv.diaChi) {
      const arr = nv.diaChi.split(",");

      diaChiChiTiet.value = arr[0]?.trim() || "";
      phuongXa.value = arr[1]?.trim() || "";
      tinhThanh.value = arr[2]?.trim() || "";
...
const luuNhanVien = async () => {
  try {
    ...
    await NhanVienApi.update(id, data);
    ...
    console.error(error);
    successMessage.value = "Cập nhật nhân viên thất bại";
