...
const selectedStatus = ref('all') // 'all', 0, 1, 2, 3, 4, 5
    ...
    <div class="bg-surface-container-lowest rounded-xl p-stack-lg shadow-sm border border-outline-variant flex flex-col gap-stack-lg">
      ...
      <div class="flex flex-wrap items-center gap-stack-sm">
        <button
          ...
          :class="selectedStatus === 'all' ? 'bg-[#EF972D] text-white border-transparent' : 'bg-surface-container-lowest border border-outline-variant text-on-surface-variant hover:border-primary-container hover:text-primary-container'"
